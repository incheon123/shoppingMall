...
<jsp:include page="../component/header.jsp" />
    ...
    <div class="service_guide">
        ...
        ■ 회원가입안내
        <br>
        ① 저희 트리플 킴은 기본적으로는 회원제로 운영하고 있습니다. 
        <br>
        ...
        ■ 마일리지 제도
        <br>
        ① 저희 트리플 킴은 마일리지를 사용할 수 있습니다. 
        <br>
        ② 마일리지 100점은 현금 100원과 같습니다. 
        <br>
        ③ 마일리지는 1원 부터 사용하실 수가 있습니다
        <br>
        <br>
        ■ 상품주문방법
        <br>
        저희 트리플 킴에서 상품을 주문하는 방법은 크게 6단계입니다. 
        <br>
        ① 상품검색 
        <br>
        ② 쇼핑백에 담기 
        ...
        ⑥ 주문 성공 화면 (주문번호) 
        <br>
        ⑦ 비회원 주문은 불가능하오니 꼭 회원가입을 부탁드립니다.
        <br>
        ■ 주문확인 및 실시간 배송조회시스템
        <br>
        트리플 킴에서 주문을 하셨을 경우 주문/배송 확인을 통해서 실제 주문이 어떻게 처리되고 있는지 확인 하실 수 있습니다. 회원페이지에서 주문/배송 확인을 클릭해 보세요. 
        <br>
        ...
        <br>
        현재 배송은 CJ대한통운 택배 서비스를 이용하고 있습니다. 본 서비스는 상품 추적을 통해 상품이 어디쯤 도착해 있는지 실시간으로 추적하실 수 있습니다. 
        <br>
        <br>
        ■ 안전한 대금 결제 시스템
        <br>
        저희 트리플 킴은 무통장 입금과 신용카드의 두 가지 결제방법을 제공하여 드립니다. 
        <br>
        무통장 입금은 상품 구매 대금은 PC뱅킹, 인터넷뱅킹, 텔레뱅킹 혹은 가까운 은행에서 직접 입금하시면 되고, 신용카드 결제는 KG이니시스 PG사의 전자결제를 이용하므로 보안문제는 걱정하지 않으셔도 되며, 고객님의 이용내역서에는 ㈜OOO으로 기록됩니다. 
        <br>
        이용 가능한 국내 발행 신용카드 
        <br>
        - 국내발행 모든 신용카드 
        ...
        <br>
        저희 트리플 킴에서는 구입하신 상품의 배송 방법을 CJ대한통운 택배 서비스를 원칙으로 하고 있습니다. (배송방법은 상품 종류에 따라 상이할 수 있습니다.)
        <br>
        <br>
        ■ 주문취소, 교환 및 환불
        <br>
        트리플 킴은 소비자의보호를 위해서 규정한 제반 법규를 준수합니다. 
        <br>
